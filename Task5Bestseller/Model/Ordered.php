<?php
namespace Speroteck\Task5Bestseller\Model;

class Ordered extends \Magento\Backend\Block\Dashboard\Grid
{
    /**
     * @var  \Speroteck\Task5Bestseller\Model\ResourceModel\CollectionFactory
     */
     ...
     * @param \Speroteck\Task5Bestseller\Model\ResourceModel\CollectionFactory $collectionFactory
     * @param array $data
     */
    public function __construct(
        ...
        \Speroteck\Task5Bestseller\Model\ResourceModel\CollectionFactory $collectionFactory,
        array $data = []
    ) {
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->_collectionFactory->create()->setModel(\Magento\Catalog\Model\Product::class);
