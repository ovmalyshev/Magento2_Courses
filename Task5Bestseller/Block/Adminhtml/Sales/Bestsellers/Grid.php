 ...
 */
namespace Speroteck\Task5Bestseller\Block\Adminhtml\Sales\Bestsellers;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'sortable' => false,
                'period_type' => $this->getPeriodType(),
                'renderer' => \Speroteck\Task5Bestseller\Block\Adminhtml\Grid\Column\Renderer\Order::class
            ]
        );
